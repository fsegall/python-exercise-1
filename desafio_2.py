...
def aplicar_poupanca(*, saldo, valor, poupanca, extrato):
...
def exibir_extrato(saldo, poupanca, /, *, extrato):
    print("\n================ EXTRATO ================")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            saldo, extrato, poupanca = aplicar_poupanca(
                saldo=saldo,
                valor=valor,
                poupanca=poupanca,
                extrato=extrato,
            ...
            saldo, extrato, poupanca = resgatar(
                saldo=saldo,
                valor=valor,
                poupanca=poupanca,
                extrato=extrato,
            ...
            exibir_extrato(saldo, poupanca, extrato=extrato)
